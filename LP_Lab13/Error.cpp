...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] = { //таблица ошибок
		...
		ERROR_ENTRY(206, "[ LEXIC ] Переменной с типом byte нельзя присвоить значение больше 255"),
		ERROR_ENTRY(207, "[ LEXIC ] Превышен размер строкового литерала"), ERROR_ENTRY_NODEF(208), ERROR_ENTRY_NODEF(209),
